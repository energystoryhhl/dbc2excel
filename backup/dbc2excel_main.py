...
class MyFrame(wx.Frame):
    ...
    def __init__(self, parent, title):
        ...
        self.check2 = wx.CheckBox(self, -1, '生成信号数值描述', pos=(250, 200), size=(100, -1))
        self.Bind(wx.EVT_CHECKBOX, self.SigValDescEvtCheckBox, self.check2)
        self.check2.Set3StateValue(True)

        #最大信号值描述长度
        self.quote = wx.StaticText(self, label="信号值描述最大文本长度\n", pos=(250, 220), size = (200, 20))
        self.text1 = wx.TextCtrl(self, wx.ID_ANY, "70",pos=(250, 240), size=(100, 20), style=wx.TE_LEFT)
    ...
    def create_excel(self, event):
        ...
        dbc.dbc2excel(self.path,self.if_sig_desc,self.if_sig_val_desc,self.val_description_max_number)
